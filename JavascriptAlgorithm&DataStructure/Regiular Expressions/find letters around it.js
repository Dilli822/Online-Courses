...
// Failed: Your regex should match two criminals (CC) in the string CC
// Failed: Your regex should match three criminals (CCC) in the string P1P5P4CCCcP2P6P3.
// Failed: Your regex should match five criminals (CCCCC) in the string P6P2P7P4P5CCCCCP3P1
// Passed: Your regex should not match any criminals in the empty string ""
// Failed: Your regex should not match any criminals in the string P1P2P3
// Failed: Your regex should match fifty criminals (CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC) in the string P2P1P5P4CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCP3.
