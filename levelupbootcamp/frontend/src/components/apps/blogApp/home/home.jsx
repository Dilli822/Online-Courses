...
const Home = () => {
    ...
    return (
        <>
          ...
          <h1 style={{ fontSize: "40px" }}> Total Blogs Count:  <span style={{ fontSize: "52px" }}> {localStorage.getItem('total_blogs_count')}
          <span style={{ fontSize: "64px", margin: 0, padding: 0 }}>+</span>{" "}
          </span>
          </h1> 
      ) : (
